...
// 	int checkpeople=Integer.parseInt(request.getParameter("checkpeople"));
	
// 	HotelDAO hDao = new HotelDAO();
	
// 	HotelServeDetailDTO detailDto = new HotelServeDetailDTO();
// 	HotelMainDTO mainDto = new HotelMainDTO();
// 	mainDto.setCity(city);
// 	detailDto.setStartdate(startdate);
// 	detailDto.setEnddate(enddate);
// 	detailDto.setCheckpeople(checkpeople);
								...
								<div class="search_hotel_wrapper">
									...
									<div class="box">
										...
										<div class="checkinoutbox">
											...
											<input class="checkinout" type="text" value="">
												...
												<div class="checkpeople_popup_wrapper">
													...
													<div class="number_input_section">
														<div class="number_input_wrapper">
															...
															<input type="text" id= "num" class="number" value="">
									...
									<div class="pink_button_wrapper">
										<button class="pink_button">검색하기</button>
									</div>
								</div>
							</form>
						</div>
...
// 									String r = (String)(request.getAttribute("result"));
									ArrayList<HotelMainDTO> listhotelmain = (ArrayList<HotelMainDTO>)request.getAttribute("listhotelmain");
								...
								%>
									<div class="result_hotel_list">
										...
										<div class="result_hotel_info">
											<div class="hotelinfoimage" style="background-image: url('../images/hotel/imglatesthotellistex01.jpg');"></div>
											<div class="contents">
