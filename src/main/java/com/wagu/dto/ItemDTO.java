...
public class ItemDTO {
	...
	public ItemDTO(int itemID, String images, String videoUrl, String available, String goodsName, float score, int reviewCnt, int price, float discount, String stringDiscountedPrice) {
		this.itemID = itemID;
		this.images = images;
		this.imagesArr = images.split("___");
		if(videoUrl != null) {
			this.videoUrl = videoUrl.replace("watch?v=","embed/");
		} else {
